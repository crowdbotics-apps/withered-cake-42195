"""
Django settings for withered_cake_42195 project.
...
ROOT_URLCONF = 'withered_cake_42195.urls'
...
WSGI_APPLICATION = 'withered_cake_42195.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_cake_42195 API",
    "DESCRIPTION": "API documentation for withered_cake_42195 App",
    "VERSION": "v1",
}
